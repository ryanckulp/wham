...
6. Delete the existing git logs with "rm -rf .git" from inside the directory then run "git init"
7. See the top of layout/application.html and pages/home.html to set page titles and descriptions
